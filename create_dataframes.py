...
customers_df.to_csv(
    "/home/martinalejandr/data-practice/spark-in-gcp/data/customers{}.csv".format(num_customers), index=False)
    
print("Exporting products")
productsdf.to_csv(
    "/home/martinalejandr/data-practice/spark-in-gcp/data/products{}.csv".format(num_products), index=False)